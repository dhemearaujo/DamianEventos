...
class WooCommerce_LiveChat implements WooCommerce_LiveChat_Interface
{
	...
	const LC_S_DISABLE_SOUNDS_KEY    = 'wc-lc_disableSounds';
	...
	private function get_integration_settings() {
		...
		if ( array_key_exists( self::LC_S_DISABLE_SOUNDS_KEY, $settings ) ) {
			$data['disableSounds'] = $settings[self::LC_S_DISABLE_SOUNDS_KEY];
		}
