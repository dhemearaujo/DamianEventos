        ...
        <div class="task-container__task-content-row">
            ...
            <div class="task-container__task-body">
                ...
                <div class="task-container__task-description">
                    ...
                    <p>
                        <?php esc_html_e('Premmerce is a toolkit of plugins which unites the most essential tools to amplify the WooCommerce core functionality together with a step-by-step tutorial, called Premmerce Wizard.','saleszone'); ?>
                    </p>
                    <p>
                        <?php esc_html_e('Kikri is ultimate framework for theme developers using the WordPress Customizer','saleszone'); ?>
                    </p>
                    <p>
    ...
    <div class="task-container__task">
        <div class="task-container__task-content-row">
            ...
            <div class="task-container__task-body">
                ...
                <div class="task-container__task-description">
                    <?php esc_html_e('Premmerce Wizard will help you with a fully set up and ready to perform WooCommerce online store.','saleszone'); ?>
                </div>
                <div class="task-container__task-footer">
                    <?php if(saleszone_is_plugin_active('premmerce/premmerce.php') || saleszone_is_plugin_active('premmerce-premium/premmerce.php')) :?>
    ...
    <div class="task-container__task <?php echo $is_checked ? 'task-container__task-checked':''; ?>>">
        <div class="task-container__task-content-row">
            ...
            <div class="task-container__task-body">
                ...
                <div class="task-container__task-description">
                    <?php esc_html_e('All Setting, Theme Options, Widgets and Menus are available via Customize screen. Have a quick look or start customization!','saleszone'); ?>
                </div>
                <div class="task-container__task-footer">
    ...
    <div class="task-container__task">
        <div class="task-container__task-content-row">
            ...
            <div class="task-container__task-body">
                ...
                <div class="task-container__task-description">
                    <?php esc_html_e('Need help in setting up and configuring? Please take a look at our documentation page.','saleszone'); ?>
                </div>
                <div class="task-container__task-footer">
