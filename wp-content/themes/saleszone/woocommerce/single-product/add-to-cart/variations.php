...
<?php do_action('woocommerce_before_variations_form'); ?>
    ...
    <?php
        ...
        do_action('saleszone_render_advanced_variation', apply_filters( 'wc_product_variable_attributes', $attributes, $attribute_keys ), $product->get_default_attributes(), $product, $attribute_keys, false)
    ?>
        <?php else: ?>
