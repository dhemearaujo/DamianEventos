...
if ( !function_exists( 'saleszone_get_product_image_url' ) ) {
    function saleszone_get_variation_image_url( $product, $size = 'shop_thumbnail' )
    {
        ...
        $main_image_src = ( wp_get_attachment_image_url( $variation->get_image_id() ) ? wp_get_attachment_image_url( $variation->get_image_id(), $size ) : esc_url( wc_placeholder_img_src() ) );
