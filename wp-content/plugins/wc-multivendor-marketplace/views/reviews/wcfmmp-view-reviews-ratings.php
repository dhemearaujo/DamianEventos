...
<?php if( $avg_review_rating ) { ?>
	<div class="rgt rating_count">
		<div class="rating_number"><?php echo round( $avg_review_rating, 1 ); ?><sub>/5</sub></div>
		<div class="rating_box">
			<i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i>
			<input type="hidden" class="store_rating_value" name="wcfm_saved_store_review_total" value="<?php echo round($avg_review_rating); ?>" />
		</div>
	</div>
<?php } ?>