...
class WCFM_Enquiry {
   ...
   */
	function wcfmmp_store_enquiry_button() {
		...
		if( apply_filters( 'wcfm_is_pref_enquiry_button', true ) ) {
			?>
			<div class="lft bd_icon_box"><a class="wcfm_store_enquiry" href="#"><div class="bd_icon"><i class="fa fa-question" aria-hidden="true"></i></div><span><?php _e( 'Inquiry', 'wc-frontend-manager' ); ?></span></a></div>
			<?php
