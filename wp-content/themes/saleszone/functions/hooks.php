 ...
 * After body tab open
 */
add_action( 'saleszone_after_body_open', 'saleszone_render_css_variable_polifil' );
/**
 * Header
 */
add_action( 'saleszone_catalog_btn_menu', 'saleszone_render_catalog_btn_menu', 10 );
add_action( 'saleszone_after_header', 'saleszone_render_breadcrumb', 10 );
add_action( 'saleszone_header_search', 'saleszone_render_header_search', 10 );
add_action( 'saleszone_after_product_search', 'saleszone_render_saleszone_search', 10 );
/**
 * Archive sidebar
 */
add_action( 'saleszone_catalog_sidebar', 'saleszone_brand_sidebar_image', 10 );
add_action( 'saleszone_catalog_sidebar', 'saleszone_dynamic_catalog_sidebar', 20 );
/**
 * Archive sidebar
 */
add_action( 'saleszone-archive-products-container-end', 'saleszone_render_archive_products_description' );
add_action( 'saleszone-archive-products-layout-body-after-header', 'saleszone_render_saleszone_active_filters_widget' );
/**
 * Subcategories sidebar
 */
add_action( 'saleszone_subcategories_sidebar', 'saleszone_dynamic_subcategories_sidebar' );
/**
 * Single product sidebar
 */
add_action( 'saleszone_product_sidebar', 'saleszone_dynamic_product_sidebar', 10 );
/**
 * Loop product
 */
...
if ( isset( $premmerce_wishlist_frontend ) ) {
    ...
    add_action( 'saleszone_loop_product_cut_after_title', 'saleszone_render_wishlist_move_button' );
}
...
add_action( 'saleszone_single_product_summary_popup_title', 'woocommerce_template_single_title', 5 );
add_action( 'saleszone_single_product_summary_popup_meta', 'woocommerce_template_single_meta', 10 );
add_action( 'saleszone_single_product_summary_header', 'woocommerce_template_single_title', 5 );
add_action( 'saleszone_single_product_summary_header', 'woocommerce_template_single_meta', 10 );
add_action( 'saleszone_single_product_summary_footer', 'saleszone_single_product_render_main_attributes', 5 );
add_action( 'saleszone_single_product_summary_footer', 'woocommerce_template_single_excerpt', 10 );
add_action( 'saleszone_single_product_summary_footer', 'woocommerce_template_single_sharing', 20 );
add_action( 'saleszone_single_product_summary_popup_footer', 'woocommerce_template_single_excerpt', 10 );
add_action( 'saleszone_single_product_summary_popup_footer', 'saleszone_template_single_more_link', 15 );
add_action( 'saleszone_single_product_summary_popup_footer', 'woocommerce_template_single_sharing', 20 );
...
add_action( 'saleszone_add_to_cart_button', 'woocommerce_template_single_price', 5 );
add_action( 'saleszone_add_to_cart_button', 'woocommerce_single_variation_add_to_cart_button', 10 );
 ...
 * Blog
 */
add_action( 'saleszone_blog_sidebar', 'saleszone_dynamic_blog_sidebar', 10 );
/**
 * Shordcodes products
 */
