...
$integration_settings['disableSounds'] = (array_key_exists('disableSounds', $integration_settings)) ? $integration_settings['disableSounds'] : 0;
...
<?php if ($integration_settings['disableSounds']) { ?>
