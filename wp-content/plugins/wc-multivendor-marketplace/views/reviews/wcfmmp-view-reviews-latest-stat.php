...
<div class="famous_reviewers">
	...
	<div class="lft m10 reviews_count">
	  <?php if( $author_name ) { ?><a href="#"><?php echo $author_name; ?></a> <?php } ?>
	  <?php if( $total_review_count > 1 ) { ?> <?php _e('and', 'wc-multivendor-marketplace' ); ?> <a href="#"><?php echo ($total_review_count-1); ?> <?php _e('others', 'wc-multivendor-marketplace' ); ?></a>
