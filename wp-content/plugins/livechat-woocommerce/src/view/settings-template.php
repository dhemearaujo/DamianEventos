...
<div id="woocommerce-livechat-container">
    ...
    <div class="woocommerce-livechat-column-right">
        ...
        <div class="settings">
            ...
            <div>
                <div class="title">
                    <span><?php _e('Disable chat window sounds', 'livechat-woocommerce'); ?></span>
                </div>
                <div class="onoffswitch">
                    <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="<?php echo $settings_disable_sounds_key ?>" <?php echo (isset($settings[$settings_disable_sounds_key]) && $settings[$settings_disable_sounds_key]) ? 'checked': '' ?>>
                    <label class="onoffswitch-label" for="<?php echo $settings_disable_sounds_key ?>">
                        <span class="onoffswitch-inner"></span>
                        <span class="onoffswitch-switch"></span>
                    </label>
                </div>
