...
<div class="modal modal--quick-view <?php if ($notices['error'] && !$notices['success']): ?>modal--sm<?php else: ?>modal--lg<?php endif; ?>">
	<?php if (has_action('saleszone_single_product_summary_popup_title')): ?>
    ...
    <div class="modal__content">
        ...
        <div class="pc-product-quick-view">
            ...
            <div id="product-<?php the_ID(); ?>" <?php post_class('pc-product-quick-view__body'); ?>
                    ...
                    <div class="pc-product-quick-view__summary-wrapper">
                        ...
                        <div class="pc-product-quick-view__summary">
                            ...
                            <div class="pc-product-summary summary entry-summary">
                                <?php if (has_action('saleszone_single_product_summary_popup_meta')): ?>
                                    <div class="pc-product-summary__header">
                                        <?php
                                        /**
                                         * @hooked woocommerce_template_single_meta - 10
                                         */
                                        do_action('saleszone_single_product_summary_popup_meta');
                                        ?>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php endif; ?>
	                            <?php if (has_action('saleszone_single_product_summary_popup_footer')): ?>
                                    <div class="pc-product-summary__footer">
			                             ...
			                             *
			                             */
			                            do_action('saleszone_single_product_summary_popup_footer');
			                            ?>
                                    </div>
	                            <?php endif; ?>
