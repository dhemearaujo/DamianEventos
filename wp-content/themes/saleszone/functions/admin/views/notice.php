<div class="notice saleszone-notice" data-get-started-notice>
    ...
    <p>
        <img src="<?php echo esc_url(get_template_directory_uri() . '/functions/admin/assets/img/logo.png'); ?>" alt="<?php echo esc_attr($themeTextDomain); ?>">
    </p>
    ...
    <p>
        ...
        printf(
                wp_kses_post(__( 'Welcome! Thank you for choosing %1$s! To fully take advantage of the best our theme can offer please make sure you visit our <a href="%2$s">Welcome page</a>', 'saleszone' )),
                    esc_html( $themeName ),
