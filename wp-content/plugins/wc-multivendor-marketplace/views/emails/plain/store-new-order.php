...
<h2 class="woocommerce-order-details__title" style="color: #00798b;"><?php _e('Order', 'wc-multivendor-marketplace'); ?> #<?php echo $order->get_order_number() . ' ('.date_i18n(wc_date_format(), strtotime($order->get_date_created())).')'; ?></h2>
	...
	<tr>
		<?php if( $WCFM->wcfm_vendor_support->wcfm_vendor_has_capability( $vendor_id, 'view_billing_details' ) ) { ?>
			<td valign="top" width="50%">
				<h3 style="color: #00798b;"><?php _e('Billing Address', 'wc-multivendor-marketplace'); ?></h3>
		...
		<?php if( ( $shipping = $order->get_formatted_shipping_address() ) && $WCFM->wcfm_vendor_support->wcfm_vendor_has_capability( $vendor_id, 'view_shipping_details' ) ) { ?>
			<td valign="top" width="50%">
				<h3 style="color: #00798b;"><?php _e('Shipping Address', 'wc-multivendor-marketplace'); ?></h3>
