...
?>
                    <?php 
esc_html_e( 'is now installed and ready to use. We hope the following information will help you. If you want to ask any query or just want to say hello, you can always contact us. We hope you enjoy it!', 'saleszone' );
?>
...
?>
                        ...
                        -->
                        <?php 
$go_premium_url = __( 'https://premmerce.com/saleszone/', 'saleszone' );
$demo_url = __( 'http://saleszone-free.premmerce.com/', 'saleszone' );
?>
