        ...
        <div class="vendor_description">
            <div class="vendor_img_add">
                ...
                <div class="vendor_address">
                    ...
                    <?php if (!empty($location) && $vendor_hide_address != 'Enable') { ?><p class="wcmp_vendor_detail"><i class="wcmp-font ico-location-icon"></i><label title="<?php echo $location; ?>"><?php echo apply_filters('vendor_shop_page_location', $vendor->get_formatted_address(array('city','state','country')), $vendor_id); ?></label></p><?php } ?>
