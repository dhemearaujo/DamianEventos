...
class WOO_Wallet_Withdrawal_Approved extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = __( 'Retirada da carteira aprovada', 'woo-wallet-withdrawal' );
		$this->description      = __( 'Esses e-mails são enviados ao usuário quando uma solicitação de retirada da carteira é aprovada', 'woo-wallet-withdrawal' );
	...
	public function get_default_subject() {
            return __( '[{site_name}] Sua solicitação de retirada foi aprovada', 'woo-wallet-withdrawal' );
	}
	...
	public function get_default_heading() {
            return __( 'Solicitação de retirada de {amount} está aprovada', 'woo-wallet-withdrawal' );
	}
