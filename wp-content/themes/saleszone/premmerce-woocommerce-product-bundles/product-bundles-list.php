                        ...
                        <div class="product-kit__item">
                            ...
                            <div class="product-kit__products">
                                <div class="product-kit__product">
                                    ...
                                    <!-- Main Product BEGIN -->
                                    <article <?php post_class('product-thumb product-thumb--kit'); ?>>
                                            ...
                                            <div class="product-thumb__right">
                                                ...
                                                <?php if ($price_html = $product->get_price_html()): ?>
                                                    <div class="product-thumb__row product-price">
                                                        ...
                                                        echo wp_kses($priceHtml , saleszone_get_allowed_html('price'));
                                                        ?>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                ...
                                <div class="product-kit__purchase-inner">
                                    ...
                                    <div class="product-kit__price">
                                        <div class="product-price product-price--md">
                                            ...
                                            <?php endif; ?>
                                            <ins><?php echo wp_kses(wc_price($productData['total_sale']) , saleszone_get_allowed_html('price')); ?></ins>
                                        </div>
                                    </div>
                                    ...
                                    <span class="product-kit__discount-title">
                                        ...
                                        <?php echo wp_kses(wc_price($productData['total_sale'] - $productData['total']) , saleszone_get_allowed_html('price')); ?>
                                    </span>
                                    </div>
